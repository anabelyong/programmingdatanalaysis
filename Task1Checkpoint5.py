...
"""
#this program accepts the input of the equations and adds values of x and y to plot a graph 
#for trajectory projectile of particle
...
def acceleration(vx, vy, beta): #function to calculate accelaration
    g=9.81 #this is the gravitational constant
    ax=(-1*beta*vx*(vx**2 +vy**2)**0.5) #formula to calculate drag force from fluid/ 
    #horizontal acceleration
    ay=(-1*beta*vy*(vx**2 +vy**2)**0.5)-g#formula to calculation acceleration due to gravity on 
...
def main(): 
    ...
    y_data=[] #lists to hold data for plotting y axis
    ...
    while y>= 0: #vertical component is always bigger than 0 until it lands
        x_data.append(x) #saving the values of horizontal axis components to be plotted on graph
        
        y_data.append(y) #saving the values of vertical axis components to be plotted on graph
